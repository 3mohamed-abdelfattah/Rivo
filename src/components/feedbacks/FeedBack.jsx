    ...
    return (
        <main className='my-20'>
            <div className='flex flex-col justify-center items-center'>
                <p className='text-primaryText text-6xl font-bold font-[RobotoSlab] p-5'>Feedback Corner</p>

                {/* FeedBacks */}
                <div className='flex flex-row justify-evenly gap-10 my-16'>
                    <div className='flex relative flex-col items-left max-w-[430px] shadow-lg rounded px-10 min-h-64'>
                    ...
                    <div className='flex relative flex-col items-left max-w-[430px] shadow-lg rounded bg-primaryBackground px-10 min-h-64'>
                        <p className='text-2xl text-primaryText font-semibold font-[RobotoSerif] mb-4'>
                            <Quote />
                            Sarah Thompson
                        </p>
